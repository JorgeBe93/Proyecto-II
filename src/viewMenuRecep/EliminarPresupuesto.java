...
public class EliminarPresupuesto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tf_out.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tf_outActionPerformed(evt);
            }
        });
        ...
        if(tf_numero.getText().length()==0){
         ...
         resp=  JOptionPane.showConfirmDialog(null,"Desea eliminar el presupuesto?", "Confirmar Eliminar",JOptionPane.YES_NO_OPTION );
              if (resp==JOptionPane.YES_OPTION){
                  ...
                  Reserva r=entityManager.find(Reserva.class, Integer.parseInt(tf_reserva.getText()));
                  valor=r.toString();
                  ...
                  //eliminamos el presupuesto
                   Presupuesto p=entityManager.find(Presupuesto.class, Integer.parseInt(tf_numero.getText()));
                   valor=p.toString();
    ...
    private void tf_outActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tf_outActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tf_outActionPerformed

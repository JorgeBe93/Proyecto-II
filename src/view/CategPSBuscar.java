 ...
 * @author Jorge
 */
public class CategPSBuscar extends javax.swing.JFrame {
    private char ch;
    private int fila;
    private int codigo;
    ...
    private void initComponents() {
        ...
        lbl_BuscarCPS.setText("Buscar Categoría de Producto/Servicio");
        ...
        if (tf_valor.getText().length()==0){
            ...
            return;
                 ...
                 if(list_filtros.getSelectedItem()=="Nombre"){
                    query = entityManager.createNativeQuery( "SELECT * FROM categoria_prod_ser WHERE nombre LIKE "
                    +"'%"+tf_valor.getText()+"%'", CategoriaProdSer.class);
                    List<CategoriaProdSer> cat=query.getResultList();
                    if(cat.isEmpty()){
                        JOptionPane.showMessageDialog(null,"Nombre de categoría de  P/S inexistente", "Error",JOptionPane.ERROR_MESSAGE);
                        tf_valor.setText(null);
                        return;
                    }
                    list.clear();
    ...
    private void masterTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_masterTableMouseClicked
        ...
        switch(MenuAdminHotel.opcion){
            case 1:
                    ...
                    JFrame frame=new CategPSEdit();
                    CategPSEdit.tf_codigoCategoria.setText(Integer.toString(codigo));
                    CategPSEdit.tf_nombre.setText(nombre);
                    frame.setVisible(true);
                    frame.setTitle("Editar Categoría de P/S");
            ...
            case 2:
                    ...
                    codigo=(Integer) masterTable.getValueAt(fila, 0);
                    nombre=(String)masterTable.getValueAt(fila, 1);
                    JFrame frame2=new CategPSEliminar();
                    CategPSEliminar.tf_codigoCategoria.setText(Integer.toString(codigo));
                    CategPSEliminar.tf_nombre.setText(nombre);
                    frame2.setVisible(true);
                    frame2.setTitle("Eliminar Categoría de P/S");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategPSBuscar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

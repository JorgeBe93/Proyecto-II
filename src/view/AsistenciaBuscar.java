 ...
 * @author Vladimir
 */
public class AsistenciaBuscar extends javax.swing.JFrame {

    /**
     * Creates new form AsistenciaBuscar
     */
    public AsistenciaBuscar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        list_filtros.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Empleado", "Nombre", "Apellido", "Fecha" }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFrame frame=new AsistenciaBuscar();

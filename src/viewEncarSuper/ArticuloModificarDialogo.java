 ...
 * @author pc
 */
public class ArticuloModificarDialogo extends javax.swing.JDialog {
...
*/
    ...
    boolean select;
    String proveedor;
    public ArticuloModificarDialogo(java.awt.Frame parent, boolean modal) {
        
        super(parent, modal);
        
       String valor= ArticuloModificarEliminar.cate;
     //  String valor= "insumos oficina";
    ...
    private void btn_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aceptarActionPerformed
        ...
        ArticuloModificarEliminar.tf_proveedor.setText(proveedor);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArticuloModificarDialogo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ArticuloModificarDialogo dialog = new ArticuloModificarDialogo(new javax.swing.JFrame(), true);
    ...
    public void inicializarLista(String art){
   
        /*
        select distinct * from proveedor p
join categoria_articulo c
on p.codigoCategoria = c.cod_categoria
where c.descripcion like "insumos oficina" ;
        */
        /*query= entityManager.createNativeQuery("select distinct * from proveedor p"
                + " join articulo a"

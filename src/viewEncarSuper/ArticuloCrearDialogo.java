 ...
 * @author pc
 */
public class ArticuloCrearDialogo extends javax.swing.JDialog {
    ...
    boolean select;
    String proveedor;
    public ArticuloCrearDialogo(java.awt.Frame parent, boolean modal) {
        
        super(parent, modal);
        
        String valor= ArticuloCreate.cate;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArticuloCrearDialogo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ArticuloCrearDialogo dialog = new ArticuloCrearDialogo(new javax.swing.JFrame(), true);

 ...
 * @author pc
 */
public class DetallePagoCheque extends javax.swing.JDialog {
  ...
  public static  int totalmonto;
    public DetallePagoCheque(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        llenarTablaDetalle();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/check-icon.png"))); // NOI18N
        ...
        lbl_registrarC.setText("Cobros Cheque");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetallePagoCheque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DetallePagoCheque dialog = new DetallePagoCheque(new javax.swing.JFrame(), true);
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
  facturaCobroQuery = entityManager.createNativeQuery( "SELECT * "+
        ...
        //  "WHERE fc.tipoFactura='Crédito/Cheque' "+
    ...
    public  static void inicializar_tabla(String entidad, int total) {
      ...
      //  fila[0] = String.valueOf(numeroFactura);
      //  fila[1]= art;
        //fila[1] = tipo;
        //fila[2] = nro;
        fila[0] = entidad;
       ...
       // totalCompra = (Integer.parseInt(txt_total.getText()) +(precio*cant) );
       ...
       facturaCobroQuery = entityManager.createNativeQuery( "SELECT * "+
              ...
              try
        {
          ...
          //  HashMap par = new HashMap();//no definimos ningún parámetro por eso lo dejamos así
            ...
            parametros.put("formaPago","Cheque" );
